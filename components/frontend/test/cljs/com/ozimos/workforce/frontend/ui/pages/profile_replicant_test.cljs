...
(deftest metadata (testing "query ident" (is (= [:new-username :error-msg :success-msg :loading :mfa-stage :mfa-secret :mfa-backup-codes :totp-code] (:query (meta sut/ProfileReplicant)))) (is (= :profile-replicant/root (:ident (meta sut/ProfileReplicant))))))
