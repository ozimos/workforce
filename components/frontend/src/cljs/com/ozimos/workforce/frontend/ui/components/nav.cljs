  ...
  (div {:className "relative inline-block text-left"}
    (if active-org
      (button {:onClick #(comp/set-state! this {:dropdown-open (not dropdown-open?)})
               :className "inline-flex items-center gap-1.5 rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-semibold text-indigo-700 hover:bg-indigo-100 ring-1 ring-inset ring-indigo-700/10 focus:outline-none"}
        (dom/svg {:xmlns "http://www.w3.org/2000/svg" :className "w-3 h-3 text-indigo-600 shrink-0" :fill "none" :viewBox "0 0 24 24" :stroke "currentColor"}
        ...
        (dom/svg {:xmlns "http://www.w3.org/2000/svg" :className "w-2.5 h-2.5 text-indigo-400 ml-0.5 shrink-0" :fill "none" :viewBox "0 0 24 24" :stroke "currentColor"}
