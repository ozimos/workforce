(ns com.ozimos.workforce.frontend.ui.pages.profile.host
  (:require
   [com.fulcrologic.fulcro.components :as comp :refer [defsc]]
   [com.fulcrologic.fulcro.dom :as dom]
   [com.ozimos.workforce.frontend.bridge :as bridge]
   [com.ozimos.workforce.frontend.ui.pages.profile :as cr]
   [goog.dom :as gdom]))
(defsc ProfileHost [_this _props]
